        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="setting.php" class="waves-effect"><i class="fa fa-cog fa-fw" aria-hidden="true"></i><span class="hide-menu">Setting</span></a>
                    </li>
                    <li>
                        <a href="404.php" class="waves-effect"><i class="fa fa-info-circle fa-fw" aria-hidden="true"></i><span class="hide-menu">Error 404</span></a>
                    </li>
                </ul>
            </div>
        </div>
